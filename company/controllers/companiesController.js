...
//     res.status(200).json({
//       success: true,
//       message: "Company JobPost Update SUccessfully",
//       company,
//     });
//   } catch (error) {
//     console.log(error);
...
const API_URL = "http://job-srv:8801/api-v1";
...
export const getCompanyById = async (req, res, next) => {
  try {
    ...
    for (let i = 0; i < jobIds.length; i++) {
      ...
      const url = `/jobs/get-job-post/${jobId}`;
